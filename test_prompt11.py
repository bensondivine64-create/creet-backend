...
full_no_context = """You are CREET's admin assistant, helping the admin manage the platform (users, listings, reports).
...
print(f"Length: {len(full_no_context)}")
r = requests.get(ENDPOINT, params={"query": full_no_context}, timeout=30)
print(r.text)
